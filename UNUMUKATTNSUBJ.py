...
def model_lstm_atten(no_classes,max_features, maxlen, embed_size, embedding_matrix):
...
def model_lstm_INFERSENT(max_no_threads, actual_threads, max_features, max_classes, maxlen, embed_size, embedding_matrix,
                        bs):
    ...
    # h_s=Dense(64)(h_s)
    # c_s = Dense(64)(c_s)
    x_r2, f_h_r2, f_c_r2, b_h_r2, b_c_r2 = Bidirectional(LSTM(64, return_state=True, return_sequences=True))(inpr,
                                                                                                             initial_state=[
                                                                                                                 f_h_s1,
                                                                                                                 f_c_s1,
                                                                                                                 b_h_s1,
    ...
    x_s2, f_h_s2, f_c_s2, b_h_s2, b_c_s2 = Bidirectional(LSTM(64, return_state=True, return_sequences=True))(inps,
                                                                                                             initial_state=[
                                                                                                                 f_h_r2,
                                                                                                                 f_c_r2,
                                                                                                                 b_h_r2,
    ...
    # h_s=Dense(64)(h_s)
    # c_s = Dense(64)(c_s)
    x_r3, f_h_r3, f_c_r3, b_h_r3, b_c_r3 = Bidirectional(LSTM(64, return_state=True, return_sequences=True))(inpr,
                                                                                                             initial_state=[
                                                                                                                 f_h_s2,
                                                                                                                 f_c_s2,
                                                                                                                 b_h_s2,
                                                                                                                 b_c_s2])
    # ,initial_state=[f_h_s,f_c_s,b_h_s,b_c_s])
    x_s3, f_h_s3, f_c_s3, b_h_s3, b_c_s3 = Bidirectional(LSTM(64, return_state=True, return_sequences=True))(inps,
                                                                                                             initial_state=[
                                                                                                                 f_h_r3,
                                                                                                                 f_c_r3,
                                                                                                                 b_h_r3,
    ...
    out_x = Concatenate(axis=1)([x_r1,x_r2,x_r3])
    #out_x=x_r2
    out_x = AttentionMV()([out_x,inpc])
    ...
    thread_model = Model(inputs=[inp_recv_t, inp_send_t,inpc], outputs=out_x)
